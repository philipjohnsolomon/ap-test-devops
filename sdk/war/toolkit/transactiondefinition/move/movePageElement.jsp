...
<c:set var="legendPath" value="${param.path}.@legend"/>
<c:set var="legendValue" value="${tk:getFieldValue(toolkitData, legendPath, type)}"/>
...
<tk:dialogForm
	...
	<tk:dialogFieldset
		...
		<tk:select path="${moveToPath}" label="Section" className="page_refresh_target">
