...
<c:set var="title" value="${tk:getFieldValue(toolkitData, titlePath, 'New Instruction')}"/>
<c:set var="type" value="${tk:getFieldValue(toolkitData, typePath, param.type)}"/>


<tr id="${basePath}" class="palette_toggle needs_palette instruction">
	<td>
		<input type="hidden" id="${basePath}_type" value="${type}"/>
