...
<c:set var="label" value="${tk:getFieldValue(toolkitData, labelPath, 'New Date Field')}"/>
...
<div id="${basePath}" class="formRow palette_toggle needs_palette fieldElement">
	<input type="hidden" id="${basePath}_type" value="date"/>
	...
	<span>
		<input type="text" name="" id="${basePath}_text" size="10" value="" disabled="disabled"></input>
	</span>
	
	<jsp:include page="datePickerFieldHelper.jsp"/>
