...
<c:set var="defaultTitle" value="${tk:getFieldValue(toolkitData, defaultPath, 'New Rule Title')}"/>
<c:set var="fieldValue" value="${tk:getFieldValue(toolkitData, fieldTitlePath, defaultTitle)}"/>

<tk:accordion fieldPath="${fieldPath}" action="loadEntry" className="arcrule" fieldValue="${fieldValue}"/>