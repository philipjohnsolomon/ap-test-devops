...
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (150, 'canBind', 'Can bind policies', 'system', SYSDATE);

insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (200, 'accessAUTOP', 'Access to personal auto work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (201, 'accessUMBRP', 'Access to personal umbrella work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (202, 'accessHOME', 'Access to homeowners work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (203, 'accessDFIRE', 'Access to dwelling fire work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (204, 'accessPPKGE', 'Access to Personal Package work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (205, 'accessBOAT', 'Access to WaterCraft work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (206, 'accessINMRP', 'Access to Personal inland marine work items', 'system', SYSDATE);

insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (300, 'accessAUTOB', 'Access to commercial auto work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (301, 'accessINMRC', 'Access to commercial inland marine auto work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (302, 'accessCPKGE', 'Access to commercial package work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (303, 'accessCRIM', 'Access to commercial crime work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (304, 'accessPROPC', 'Access to commercial property work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (305, 'accessUMBRC', 'Access to commercial umbrella work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (306, 'accessWORK', 'Access to workers compensation work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (307, 'accessBOP', 'Access to business owners policy work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (308, 'accessCGL', 'Access to general liability work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (309, 'accessCFRM', 'Access to farmowners work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (310, 'accessCLACCOUNT', 'Can access to Commercial lines Account', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (311, 'accessPLACCOUNT', 'Can access to Personal lines Account', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (312, 'accessACCOUNT', 'Can access to Account', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (313, 'accessPROF', 'Can access to Professional Liability', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (314, 'accessMROF', 'Access to management liability work items', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (315, 'accessCanClaim', 'Can Claim', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (316, 'accessGARAG', 'Access to Commercial Garage Work Items', 'system', SYSDATE);


insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (800, 'addSubject', 'Add a subject/user', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (801, 'getSubjects', 'Get subjects', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (802, 'getUserGroups', 'Get user groups', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (803, 'getPermissions', 'Get permissions', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (804, 'getRoles', 'Get roles', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (805, 'removeSubject', 'Remove a subject', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (806, 'modifySubject', 'Modify a subject', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (807, 'addUserGroup', 'Add a user group', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (808, 'removeUserGroup', 'Remove a user group', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (809, 'modifyUserGroup', 'Modify a user group', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (810, 'addMemberToUserGroup', 'Add a member to a user group', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (811, 'removeMemberFromUserGroup', 'Remove a member from a user group', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (812, 'addRole', 'Add a role', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (813, 'removeRole', 'Remove a role', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (814, 'modifyRole', 'Modify a role', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (815, 'addPrincipalToRole', 'Add a principal to role', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (816, 'removePrincipalFromRole', 'Remove a principal from a role', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (817, 'addPermissionToRole', 'Add a permission to a role', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (818, 'removePermissionFromRole', 'Remove a permission from a role', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (819, 'addPermission', 'Add a permission', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (820, 'removePermission', 'Remove a permission', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (821, 'modifyPermission', 'Modify a permission', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (822, 'accessAnalyticsReport', 'View analytics report', 'system', SYSDATE);


delete from rolegroup;
insert into rolegroup(role_id, role_name, role_description, last_update_by, last_update) VALUES (800, 'admin', 'administrative role', 'system', SYSDATE);
insert into rolegroup(role_id, role_name, role_description, last_update_by, last_update) VALUES (100, 'agent', 'agent role', 'system', SYSDATE);
insert into rolegroup(role_id, role_name, role_description, last_update_by, last_update) VALUES (200, 'agentpl', 'agent role personal lines', 'system', SYSDATE);
insert into rolegroup(role_id, role_name, role_description, last_update_by, last_update) VALUES (300, 'agentcl', 'agent role commercial lines', 'system', SYSDATE);
insert into rolegroup(role_id, role_name, role_description, last_update_by, last_update) VALUES (400, 'underwriter', 'underwriter role', 'system', SYSDATE);
insert into rolegroup(role_id, role_name, role_description, last_update_by, last_update) VALUES (401, 'underwriterpl', 'underwriter role personal lines', 'system', SYSDATE);
insert into rolegroup(role_id, role_name, role_description, last_update_by, last_update) VALUES (402, 'underwritercl', 'underwriter role comml lines', 'system', SYSDATE);

insert into rolegroup(role_id, role_name, role_description, last_update_by, last_update) VALUES (900, 'agent900', 'agent 900 role', 'system', SYSDATE);
insert into rolegroup(role_id, role_name, role_description, last_update_by, last_update) VALUES (901, 'agent901', 'agent 901 role', 'system', SYSDATE);
...
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (899, 'accessMenu_My Reports', 'Access My Report Menu', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (900, 'accessMenu_Home', 'Access Home Menu', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (901, 'accessMenu_My Work', 'Access My Work Menu', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (902, 'accessMenu_My Accounts', 'Access My Accounts Menu', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (903, 'accessMenu_Toolkit', 'Access Toolkit Menu', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (904, 'accessMenu_Settings', 'Access Settings Menu', 'system', SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (905, 'accessMenu_Users', 'Access Users Menu', 'system', SYSDATE);
...
*/
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (906, 'canViewAgentWorkItemsView', 'Can View Agent Work Items View', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (907, 'canViewUnderWriterWorkItemsView', 'Can View UnderWriter Work Items View', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (908, 'canViewAdminWorkItemsView', 'Can View Admin Work Items View', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (920, 'canViewUnderWriterPendingItemsView', 'Can View Admin/UW Pending Upload Work Items View', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (921, 'canViewAgentPendingItemsView', 'Can View Agent Pending Upload Work Items View', 'system',  SYSDATE);
...
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (909, 'accessCanDelete', 'Can Delete Work Item', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (911, 'accessCanCopy', 'Can Copy Work Item', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (930, 'accessCanViewAccount', 'Can View Account', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (931, 'accessCanMove', 'Can Move Work Item', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (932, 'accessCanMerge', 'Can Merge Account', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (933, 'accessCanOpen',  'Can Open', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (934, 'accessCanApprove',  'Can Approve', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (935, 'accessCanLink', 'Can Link Work Item', 'system',  SYSDATE);
...
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (912, 'canViewTotalSubmissions', 'Can View Total Submissions', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (913, 'canViewMonthlySubmissions', 'Can View Monthly Submissions', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (914, 'canViewMonthlySubmissionsPremium', 'Can View Monthly Submissions Premium', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (915, 'canViewTopTenUnderWritingRules', 'Can View Top Ten Under Writing Rules', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (916, 'canViewLOBSubmissionsByStatus', 'Can View LOB Submissions By Status', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (917, 'canViewTransactionAudit', 'Can View Transaction Audit', 'system',  SYSDATE);
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (918, 'canViewTotalSubmissionsPremium', 'Can View TotalSubmissions Premium', 'system',  SYSDATE);
...
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (919, 'canAccessTimeline', 'Can access to Timeline', 'system',  SYSDATE);
...
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (950, 'canViewAdminAccountsView', 'Can View Admin Account Items View', 'system',  SYSDATE);
...
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (960, 'canViewAccountItemsView', 'Can View Admin and Underwriter Account Work Items View', 'system',  SYSDATE); 
...
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (970, 'canViewAgentAccountItemsView', 'Can View Agent Account Work Items View', 'system',  SYSDATE); 
...
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (980, 'canViewAgentAccountsView', 'Can View Admin Account Work Items View', 'system',  SYSDATE);
...
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (1100, 'canAccessActivityTracker', 'View event update', 'system', SYSDATE);
...
*/
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES (1110, 'canDeleteWorkItemAssistantAttachedFile', 'permision to delete attached files', 'system', SYSDATE);
...
*/
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) VALUES(1200, 'canReadSecureData', 'Can read the raw values of a work items TDF fields which have an enabled SecureDataEntryMode', 'system', SYSDATE);
...
* Solr administration
*/
insert into permission (permission_id, permission_name, permission_description, last_update_by, last_update) values (937, 'accessMenu_Solr_Admin', 'Access Solr Administration link in main menu', 'system', SYSDATE);
...
values (938, 'accessCanEndorse', 'Can Endorse Work Item', 'system', SYSDATE);
...
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) 
VALUES (10001, 'canExecuteSynchronizationServices', 'Authorization to execute incoming web service traffic for the synchronizing database with external system', 'system', SYSDATE);
...
*/
insert into permission(permission_id, permission_name, permission_description, last_update_by, last_update) 
VALUES (11001, 'canExecuteDebugProvider', 'Authorization to execute the debug provider (debug console)', 'system', SYSDATE);
