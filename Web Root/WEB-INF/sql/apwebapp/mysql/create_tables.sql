...
(
	...
	menu    				LONGTEXT, /* Changed from varchar(2000) as of apwebapp 3.5 */
	last_update_by		    varchar(128),
	last_update			    timestamp NOT NULL
);
...
(
	...
	num_issues			integer,
	last_impactful_change_on timestamp,
